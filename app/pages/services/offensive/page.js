                ...
                <div className='grid grid-cols-12 justify-center'>
                    <div className='col-span-12 flex justify-center items-center text-center'>
                        <div className='mx-auto max-w-1145 px-4 sm:px-6 lg:px-8 justify-center '>
                            ...
                            <div className=' py-2'>
                                <h1 className=' font-bold text-5xl leading-[67px] items-center '>Offensive Security </h1>
                            </div>
                            <div className=' py-2'>
            ...
            <div className='mx-auto max-w-1145 px-4 sm:px-6 lg:px-8 justify-center '>
                <div className='lg:grid grid-cols-12 py-10 flex flex-col-reverse'>
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex'>
                        <div>
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202] '>Red Teaming</h1>
                    ...
                    <div className='lg:col-span-7 col-span-12 flex justify-center'>
                ...
                <div className='grid grid-cols-12 py-10'>
                    ...
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex'>
                        <div>
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202]'>Purple Teaming</h1>
                ...
                <div className='lg:grid grid-cols-12 py-10 flex flex-col-reverse'>
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex'>
                        <div>
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202]'>Cloud Securit</h1>
                ...
                <div className='grid grid-cols-12 py-10'>
                    ...
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex'>
                        <div>
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202]'>Web & Mobile Application Testing</h1>
                ...
                <div className='lg:grid grid-cols-12 py-10 flex flex-col-reverse'>
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex'>
                        <div>
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202]'>Network Testing: External & Internal</h1>
                ...
                <div className='grid grid-cols-12 py-10 '>
                    <div className='lg:col-span-7 col-span-12 flex justify-center lg:order-first'>
                    ...
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex lg:order-last'>
                        <div >
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202]'>Wireless Testing</h1>
                ...
                <div className='lg:grid grid-cols-12 py-10 flex flex-col-reverse'>
                    <div className='lg:col-span-5 col-span-12 items-center lg:text-start text-center lg:justify-start justify-center flex'>
                        <div>
                            <h1 className=' font-bold text-[42px] leading-[58px] text-[#050202]'>Social Engineering: Phishing</h1>
