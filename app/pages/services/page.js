...
function Services() {
    ...
    return (
        <div>
            ...
            <div className=' min-h-[981px] flex justify-center bg-cover bg-no-repeat bg-center relative overflow-hidden bg-rectangle ' >
                <div className='inset-0  absolute bg-cover bg-center bg-hero-vector min-h-[892px] min-w-[2078px]'></div>

                <div className='mx-auto max-w-1145 px-4 sm:px-6 lg:px-8 flex justify-center  items-center'>
                    <div className='grid grid-cols-12'>
                        <div className='col-span-12'>
                            <h1 className='text-center font-bold text-[42px] leading-[58px] tracking-[1px] mb-5'>Why GapSec?</h1>
                            <p className='text-[#050202] opacity-[70%] font-normal text-xl leading-8 text-center mb-6'>We are a team of dedicated security professionals who prioritize the values of trust, expertise, <br className='md:block hidden' />
                                and innovation in providing comprehensive and tailored security solutions to our clients.</p>
                            <p className='text-[#050202] opacity-[70%] font-normal text-xl leading-8 text-center mb-10'>By choosing us, clients can expect increased protection against cyber threats, enhanced <br className='md:block hidden' />
