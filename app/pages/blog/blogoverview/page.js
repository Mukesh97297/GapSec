...
function Blogoverview() {
  return (
            ...
            <div className='col-span-12 flex justify-center items-center'>
                <div className='mx-auto max-w-1145 px-4 sm:px-6 lg:px-8  '>
                    <div className='lg:justify-start justify-center flex  py-2'>
                        <ul className='md:flex block gap-2 text-red-600 font-normal lg:text-base text-sm leading-6 text-center'>
                            <li>HOME</li>
                    ...
                    <div className=' py-2 flex lg:text-start text-center'>
                        <h1 className=' font-bold lg:text-5xl text-3xl leading-10  lg:leading-[67px]'>How to Track All of Your  <br className='md:block hidden' /> Fourth-Party Cybersecurity  <br className='md:block hidden' /> Risks</h1>
                    </div>
                    <div class="flex items-center lg:justify-start justify-center  ">
                        ...
                        <div className="text-sm">
                            <p className="text-[#0D0D0D] font-bold lg:text-base leading-5">John Smith</p>
    ...
    <div className='mx-auto max-w-1145 px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-12 justify-center'>
            <div className=' col-span-12 flex justify-center items-center'>
                <div className='py-20 md:pl-20 pl-0 lg:text-start text-center'>
                    ...
                    <div className='py-20'>
                        <h1 className='font-bold lg:text-4xl text-3xl leading-8  lg:leading-10 text-[#050202]'>The 5G Network vs. Previous Generations</h1>
                    ...
                    <div>
                        <h1 className='font-bold lg:text-4xl text-3xl leading-8  lg:leading-10 text-[#050202]'>The 5G Network</h1>
